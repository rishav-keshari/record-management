...
export class SaleComponent implements OnInit {
  ...
  saleModelObj : SaleModel = new SaleModel();
  ...
  addSaleDetails(){
    ...
    this.saleModelObj.billDate = formatDate(this.formValue.value.billDate,'yyyy-MM-dd', 'en-US');
    this.saleModelObj.partyName = this.formValue.value.partyName.trim();
    this.saleModelObj.address = this.formValue.value.address.trim();
    this.saleModelObj.gstNum = this.formValue.value.gstNum.trim();
    this.saleModelObj.cust_billDate = formatDate(this.formValue.value.cust_billDate, 'yyyy-MM-dd', 'en-US');
    this.saleModelObj.invoiceNum = this.formValue.value.invoiceNum.trim();
    this.saleModelObj.itemName = this.formValue.value.itemName.trim();
    this.saleModelObj.hsnCode = this.formValue.value.hsnCode.trim();
    this.saleModelObj.saleBag = this.formValue.value.saleBag.trim();
    this.saleModelObj.saleWeight = this.formValue.value.saleWeight.trim();
    this.saleModelObj.taxFreeValue = this.formValue.value.taxFreeValue.trim();
    this.saleModelObj.taxInvoiceValue = this.formValue.value.taxInvoiceValue.trim();
    this.saleModelObj.cgst = this.formValue.value.cgst.trim();
    this.saleModelObj.sgst = this.formValue.value.sgst.trim();
    this.saleModelObj.igst = this.formValue.value.igst.trim();
    this.saleModelObj.tds = this.formValue.value.tds.trim();
    this.saleModelObj.tcs = this.formValue.value.tcs.trim();
    this.saleModelObj.grandTotal = this.formValue.value.grandTotal.trim();


    this.apiService.postSale(this.saleModelObj)
    .subscribe(res=>{
